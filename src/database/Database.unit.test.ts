/**
 * Database Unit Tests - Using Mock Database
 * These tests run without PostgreSQL using in-memory mock
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { MockDatabase, createMockDatabase, destroyMockDatabase } from '../../tests/helpers/mock-db';
import { User, Strategy, Trade } from './types';

describe('Database (Unit Tests with Mock)', () => {
  let db: MockDatabase;
